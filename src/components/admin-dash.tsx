...
export function AdminDash(){
    ...
    return(
        <div>
            <h3 className="d-flex mt-4 justify-content-between"> <span>Admin Dash</span> <span>{cookies['admin_id']}</span> <button className="btn btn-danger" onClick={SignoutClick}>SignOut</button> </h3>
            <div className="mt-4">
